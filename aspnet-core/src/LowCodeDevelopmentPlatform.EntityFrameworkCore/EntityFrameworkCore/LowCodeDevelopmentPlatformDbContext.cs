...
namespace LowCodeDevelopmentPlatform.EntityFrameworkCore
{
    ...
    public class LowCodeDevelopmentPlatformDbContext : 
        AbpDbContext<LowCodeDevelopmentPlatformDbContext>,
        IIdentityDbContext,
        ITenantManagementDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //{
            //    b.ToTable(LowCodeDevelopmentPlatformConsts.DbTablePrefix + "YourEntities", LowCodeDevelopmentPlatformConsts.DbSchema);
